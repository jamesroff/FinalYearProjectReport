...
Here, it is useful to introduce $\zeta = \sqrt{2} \pi D C_d$.
...
Final generalised equation for $\dot{C}_n(t)$:
~ 
\begin{equation*}
\begin{split}
    \dot{C}_n &=
...
Taking the one-mode truncation, the ordinary differential equations are:
~
\begin{equation*}
\begin{split}
